...
const Home = () => {
  ...
  return (
    <div className="w-full h-full py-8 max-w-[900px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-5 items-start">
        <div className="w-full flex flex-row gap-x-5 justify-between items-center">
          ...
          />
          <button
            className="text-white bg-blue-600 hover:bg-blue-800 font-medium rounded-lg text-medium px-8 py-[6px] me-1 mb-[8px] dark:bg-blue-600 dark:hover:bg-blue-700"
            onClick={createPaste}
          >
        ...
        >
          ...
          >
            ...
            {/* <div className="w-full flex gap-x-[6px] items-center select-none group">
              ...
              <div
                className={`w-[px] h-[13px] rounded-full flex items-center justify-center p-[1px] overflow-hidden bg-[rgb(254,188,46)]`}
              />
